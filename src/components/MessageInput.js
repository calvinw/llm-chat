...
import { useRef, useEffect } from 'https://esm.sh/preact@10.19.3/hooks';
  ...
  return html`
    <div className="p-4 bg-white flex-shrink-0">
      <form onSubmit=${handleSubmit} className="w-full">
        <div className="flex items-center bg-gray-100 rounded-full border border-gray-200 p-2 gap-2">
          ...
          <textarea 
            ...
            onInput=${handleInput}
            style="min-height: 24px; line-height: 1.5; max-height: 200px;"
      ...
      <div className="mt-3 flex flex-wrap gap-2">
        ${defaultPrompts.map((prompt, index) => html`
          <button
            key=${index}
