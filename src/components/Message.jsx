          ...
          <div className="px-3 pb-3 border-t border-purple-200 space-y-3 text-sm">
            ...
            <div>
              ...
              <div className="bg-blue-50 p-2 rounded border">
                <pre className="whitespace-pre-wrap text-xs">{JSON.stringify(getFullDisplayArgs(), null, 2)}</pre>
              </div>
            </div>
  ...
  return (
    <div className={`chat-message p-3 rounded border border-gray-200 ${borderClass}`}>
      ...
      <span 
        ...
        ref={contentRef}
        dangerouslySetInnerHTML={{ __html: renderMessage(message.content, message.role) + streamingIndicator }}
      />
    </div>
  );
});
