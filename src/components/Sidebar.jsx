...
const Sidebar = ({ 
    ...
    return (
        <>
            ...
            <div className={`fixed left-0 top-0 h-full bg-white border-r border-gray-200 text-gray-900 transition-all duration-300 z-20 ${
            ...
            {!isVisible && (
                <button
                    onClick={onToggle}
                    className="lg:hidden fixed top-4 left-4 z-30 p-3 bg-white rounded-full shadow-lg border border-gray-200 text-gray-600 hover:bg-gray-50 transition-colors"
